import {Box, Flex, Grid, Heading, HStack, Spacer, VStack} from "@kuma-ui/core"
    ...
    return <>
        ...
        <Flex gap={8}>
            <VStack flex={1}>
                <HStack gap={8} alignItems={"center"} mb={8}>
                    ...
                    <Heading fontSize={20} fontWeight={"bold"}>教练</Heading>
                </HStack>
                <HStack gap={8}>
            ...
            <VStack flex={1}>
                <HStack gap={8} alignItems={"center"} mb={8}>
                    <Box height={20} width={10} bg="#CFE4F0"></Box>
                    <Heading fontSize={20} fontWeight={"bold"}>学生教练</Heading>
                </HStack>
                <HStack gap={8}>
        ...
        <Flex gap={8}>
            <VStack flex={1}>
                <HStack gap={8} alignItems={"center"} mb={8}>
                    <Box height={20} width={10} bg="#CFE4F0"></Box>
                    <Heading fontSize={20} fontWeight={"bold"}>队长</Heading>
                </HStack>
                <HStack gap={8}>
            ...
            <VStack flex={1}>
                <HStack gap={8} alignItems={"center"} mb={8}>
                    <Box height={20} width={10} bg="#CFE4F0"></Box>
                    <Heading fontSize={20} fontWeight={"bold"}>副队长</Heading>
                </HStack>
                <HStack gap={8}>
        ...
        <HStack gap={8} alignItems={"center"} mb={8}>
            <Box height={20} width={10} bg="#CFE4F0"></Box>
            <Heading fontSize={20} fontWeight={"bold"}>正式队员</Heading>
        </HStack>
        ...
        <HStack gap={8} alignItems={"center"} mb={8}>
            <Box height={20} width={10} bg="#CFE4F0"></Box>
            <Heading fontSize={20} fontWeight={"bold"}>预备队员</Heading>
        </HStack>
        <Flex gap={8} flexWrap={"wrap"}>
